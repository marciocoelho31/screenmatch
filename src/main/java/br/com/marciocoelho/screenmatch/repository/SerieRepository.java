...
public interface SerieRepository extends JpaRepository<Serie, Long> {
    ...
    @Query("select s from Serie s where s.totalTemporadas <= :qtdMaxTemporadas and s.avaliacao >= :avaliacaoMinima")
    List<Serie> seriesPorTemporadaEAvaliacao(int qtdMaxTemporadas, double avaliacaoMinima);
